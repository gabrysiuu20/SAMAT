...
export default function MainPage({ isPending }) {
    const [vncUrl, setVncUrl] = useState(atob('d3M6Ly8xOTIuMTY4LjE5OS4xNjA6NzAwMQ=='))
    const [uploadedFile, setUploadedFile] = useState("")
    const [chooseVnc, setchooseVnc] = useState("2")
    ...
    return (<>
      ...
      <Container>
        ...
        <Nav className="me-auto">
          ...
          <Nav.Link active={true} href="second-vm">ANDROID 12 (BlissOS)</Nav.Link>
        </Nav>
      </Container>
      </Navbar>
                  ...
                  <Row>
                    <Col>
                      <InfoBoxLongBottomSection>
                        <WrapperDiv><div><Badge bg="dark">Nazwa pakietu</Badge> {samatPackageName}</div></WrapperDiv>
